...
// through to Cloudinary. 8MB cap is generous for a phone photo or a scanned
// document while still guarding against someone uploading something absurd.
const upload = multer({
...
// Generic, reusable image/PDF upload — not tied to a specific module. The
